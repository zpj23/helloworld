<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@page import="com.sys.entity.MenuInfo"%>
...
function initMenu(){
		...
		if(menu_arr[i].parentid==1||menu_arr[i].parentid=="1"){//第一层菜单
			...
			for(var j=0;j<menu_arr.length;j++){
				...
				if(menu_arr[j].parentid==menu_arr[i].id){//子菜单
					...
					htmlStr+="<li><a data-href=\"${ctx}/"+menu_arr[j].url+"\" data-title=\""+menu_arr[j].name+"\" href=\"javascript:void(0)\">"+menu_arr[j].name+"</a></li>";
	...
	$('#menuD').html(htmlStr);
    var div=$("<div class=\"dislpayArrow  hidden-xs\"><a class=\"pngfix\" href=\"javascript:void(0);\" onClick=\"displaynavbar(this)\"></a></div>");
	$("aside").after(div);
	$(".Hui-aside").Huifold({
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${jluserinfo.loginname} <i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
				...
				<li id="Hui-msg"> <a href="#" title="采购单数目s"><span class="badge badge-danger">${count}</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i></a> </li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${ctx}/login/main"></iframe>
	</div>
</div>
</section>
